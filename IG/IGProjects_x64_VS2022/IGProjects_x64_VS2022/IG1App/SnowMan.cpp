...
SnowMan::SnowMan(GLdouble radius)
{
    ...
    bottomHat->setMaterial(Material(glm::vec4{ 0,0.95,1,1 }));
    ...
    topHat->setMaterial(Material(glm::vec4{ 1,0,0,1 }));
    addEntity(hat);
    ...
    addEntity(nose);
    nose->setMaterial(Material(glm::vec4{ 1,0.65,0,1 }));
    ...
    addEntity(eyeL);
    eyeL->setMaterial(Material(glm::vec4{ 0,0.5,0.5,1 }));
