...
Este es un ejemplo de arquitectura servidor/cliente donde el servidor recibe mensajes, los imprime en pantalla y responde al cliente con el mensaje "Received". Los clientes desconectan después de recibir el mensaje. 


Existen dos variantes de implementación:

- TCP: Hay que establecer un conexion antes de enviar un mensaje.

- UDP:  Cualquier cliente puede enviar mensajes sin establecer una conexión.
