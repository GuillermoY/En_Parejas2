...
public:
	...
	void shoot(Vector2D p, Vector2D v, int width, int height, float r, Uint8 shooter, Uint32 timestamp) override;
	void reset() override;
	void disable_bullet(Uint8 shooter, Uint32 timestamp) override;
