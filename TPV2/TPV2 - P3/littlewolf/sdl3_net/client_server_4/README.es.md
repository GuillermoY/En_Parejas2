...
Este es un ejemplo de servidor/cliente. El servidor recibe diferentes tipos de mensajes que correspondedn a operaciones (operación binaria, número aleatorio o suma), calcula el resultado y lo envía de vuelta al cliente. Por su parte, el cliente elige qué mensaje desea enviar, completa la información necesaria y la envía al servidor.

**Esta versión utiliza structs (que comparten memoria con el búfer) para construir los mensajes.**
