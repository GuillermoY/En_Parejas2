...
static void present(const Gpu gpu)
{
    ...
    SDL_RenderTextureRotated(gpu.renderer, gpu.texture, NULL, &dst, -90, NULL, SDL_FLIP_NONE);
...
static Hero spin(Hero hero, const bool* key)
{
...
static Hero move(Hero hero, const char** const walling, const bool* key)
{
